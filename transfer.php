...
<body style="margin: 50px">
    ...
    if (isset($_POST["submit"])) {
       ...
       $receiver_first_name = $receiver["first_name"];
        ...
        if ($sender_balance < $amount) {
            ...
            $sql = "INSERT INTO transfers (sender_first_name,sender_last_name, sender_id, receiver_first_name,receiver_last_name, receiver_id, amount) VALUES ('$sender_first_name','$sender_last_name', '$sender_id', '$receiver_first_name','$receiver_last_name', '$receiver_id','$amount')";
            if (!$connection->query($sql)) {
    ...
    <div class="container">
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input style="padding:10px" type="text" class="form-control" id="sender-name" name="sender_first_name"+"sender_last_name"
                    value="<?php echo $sender["first_name"],' ', $sender["last_name"]; ?>" readonly>
            </div>
            <div class="form-group">
    ...
    <div class="nav"> <a class="reload" href="Customers.php">Back to All Customers</a> </div>
</body>
